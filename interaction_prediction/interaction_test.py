...
from waymo_open_dataset import scenario_pb2
...
class InteractionPredictionTestProcessor(DataProcess):
    ...
    def process_frame(self, timestep, sdc_id, tracks):      
        ...
        ego, neighbors, map_lanes, map_crosswalks, ground_truth = self.normalize_data(ego, neighbors, agent_map_lanes, agent_map_crosswalk, ground_truth, viz=False)
...
def interaction_test():
    ...
    # data processor
    processor = InteractionPredictionTestProcessor()
    ...
    gameformer = GameFormer(modalities=6, neighbors_to_predict=1, future_len=80).to(args.device)
    ...
    for file in test_files:
        ...
        for scenario in scenarios:
            ...
            if args.eval_scenario_id and scenario_id != args.eval_scenario_id:
                continue
